#!/usr/bin/env python3
"""
Unit tests for H.A - Limpeza Financial & Pricing Calculations
"""
...
class TestHAFinancialEngine(unittest.TestCase):
    ...
    def test_baseline_pricing_structure(self):
    ...
    def test_unit_economics_cogs_calculation(self):
        # Scenario: T2 Property Prep
        price = 390.0
        techs = 2
        hours = 4.5
        cost_hour = 14.0
        ...
        mo = techs * hours * cost_hour # 2 * 4.5 * 14 = 126.0
        travel = km * km_cost # 10.0
        cogs = mo + consumables + travel + tolls + insurance # 126 + 25 + 10 + 4.5 + 10 = 175.50
        profit = price - cogs # 390 - 175.5 = 214.50
        margin_pct = (profit / price) * 100 # 55.0%
    ...
    def test_five_year_revenue_targets(self):
